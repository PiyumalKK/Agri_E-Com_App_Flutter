...
import 'package:go_kart/pages/category/Seeds%20&%20Plants/get_products_seeds.dart';
...
class Seeds extends StatefulWidget {
  ...
  const Seeds({Key? key, required this.data}) : super(key: key);

  @override
  _ToolsState createState() => _ToolsState();
}

class _ToolsState extends State<Seeds> {
  bool progress = true;
