...
class _FaqPageState extends State<FaqPage> {
  final faqList = [
    ...
    {
      'question':
          'How can I add a new delivery address to my GoviyaGoda account?',
      'answer':
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('GoviyaGoda FAQ'),
        titleSpacing: 0.0,
