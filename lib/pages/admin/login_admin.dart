...
import 'package:go_kart/pages/admin/admin_page.dart'; // Import your Admin Page
...
class _LoginState extends State<Login_Admin> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (user != null) {
        // Fetch user data from Firestore (assuming you store user data there)
